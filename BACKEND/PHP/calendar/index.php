...
<body>
                ...
                <div class="modal-body">
                    ...
                    <div id="visualizarEvento">
                        ...
                        <dl class="row">
                            ...
                            <dt class="col-sm-3">Salas: </dt>
                            <dd class="col-sm-9" id="visualizar_salas"></dd>

                            <dt class="col-sm-3">Recursos: </dt>
                            <dd class="col-sm-9" id="visualizar_recursos"></dd>
    ...
    <script src='../../../FRONTEND/js/core/locales-all.global.min.js'></script>
