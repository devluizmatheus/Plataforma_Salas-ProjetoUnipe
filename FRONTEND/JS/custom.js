...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function (info) {
            ...
            document.getElementById("visualizar_salas").innerText = info.extendedProps.event.salas;
            document.getElementById("visualizar_recursos").innerText = info.extendedProps.event.recursos;
            document.getElementById("visualizar_descricao").innerText = info.extendedProps.event.descricao;
